ITEM_DEFAULT_ILVL = 430
ITEM_MATERIAL_TYPES = {-1: "Consumables", 0: "Not Defined", 1: "Metal", 2: "Wood", 3: "Liquid", 4: "Jewelry", 5: "Mail", 6: "Plate", 7: "Cloth", 8: "Leather"}
ITEM_QUALITY_COLORS = [(157,157,157),(255,255,255),(30,255,0),(0,112,221),(163,53,238),(255,128,0),(230,204,128),(0,204,255),(0,204,255)]
ITEM_INVTYPE = {
    0: -1,
    1: 0, #Head	
    2: 2, #Neck
...
ITEM_FLAGS = {
	2: 'Conjured item',
	3: 'Openable (can be opened by right-click)',
	4: 'Makes green Heroic text appear on item',
	5: 'Deprecated Item',
	6: 'Item can not be destroyed, except by using spell (item can be reagent for spell)',
	...
	15: 'Only readable items have this (but not all)',
	19: 'Item can be prospected',
	20: 'Unique equipped (player can only have one equipped at the same time)',
	22: 'Item can be used during arena match',
	23: 'Throwable',
	24: 'Item can be used in shapeshift forms',
	26: "Profession recipes",
	27: 'Item cannot be used in arena',
	28: 'Bind to Account (Also needs Quality = 7 set)',
	29: 'Spell is cast with triggered flag',
	30: 'Millable',
	32: 'Bind on Pickup tradeable',
    33: 'Horde only',
    34: 'Alliance only',
    35: 'Requires gold',
    41: 'Need roll disabled',
    42: 'Caster Weapon',
    63: 'MoP Heroic',
    64: 'Crafting Reagent',
...
SPELL_TARGETS = {
    ...
    108: 'TARGET_GAMEOBJECT_CONE_108',
    109: 'TARGET_GAMEOBJECT_CONE_109',
    110: 'TARGET_UNIT_CONE_ENTRY_110',
    111: 'TARGET_UNK_111',
    112: 'TARGET_UNK_112',
    113: 'TARGET_UNK_113',
    114: 'TARGET_UNK_114',
    ...
    127: 'TARGET_UNK_127',
    128: 'TARGET_UNK_128',
    129: 'TARGET_UNIT_CONE_ENTRY_129',
    130: 'TARGET_UNK_130',
    131: 'TARGET_UNK_131',
    132: 'TARGET_UNK_132',
    133: 'TARGET_UNK_133',
...
CHR_PRIMARY_STATS = [3,4,5,6,71,72,73,74]
CHR_STATS =  [
    'Mana',
    'Health',
    '',
